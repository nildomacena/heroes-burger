...
export class Tab1Page {
  ...
  constructor(
    ...
    this.combos = [
      ...
      {titulo: 'Combo Hulk', imagem: 'hulk.png', preco: 21, descricao: 'Sanduíche Hulk + 1 Batata + 1 refrigerante lata'},
      {titulo: 'Combo Formiga', imagem: 'formiga.png', preco: 21, descricao: 'Sanduíche Homem-Formiga + 1 Batata + 1 refrigerante lata'}
    ];
